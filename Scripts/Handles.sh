...
if [ -d *"openclash"* ]; then
	...
	CORE_SMART="https://github.com/vernesong/OpenClash/blob/core/dev/smart/clash-linux-$CORE_TYPE.tar.gz"
	 CORE_MATE="https://github.com/vernesong/OpenClash/blob/core/dev/meta/clash-linux-$CORE_TYPE.tar.gz"
